...
class RawUnits extends capnp_ts_1.Struct {
    getWord0() { return capnp_ts_1.Struct.getUint64(0, this); }
    setWord0(value) { capnp_ts_1.Struct.setUint64(0, value, this); }
    getWord1() { return capnp_ts_1.Struct.getUint64(8, this); }
    setWord1(value) { capnp_ts_1.Struct.setUint64(8, value, this); }
    getWord2() { return capnp_ts_1.Struct.getUint64(16, this); }
    setWord2(value) { capnp_ts_1.Struct.setUint64(16, value, this); }
    getWord3() { return capnp_ts_1.Struct.getUint64(24, this); }
    setWord3(value) { capnp_ts_1.Struct.setUint64(24, value, this); }
    toString() { return "RawUnits_" + super.toString(); }
}
exports.RawUnits = RawUnits;
RawUnits._capnp = { displayName: "RawUnits", id: "900197826a23369a", size: new capnp_ts_1.ObjectSize(32, 0) };
...
(function (NewOrderRejectReason) {
    NewOrderRejectReason[NewOrderRejectReason["UNCLASSIFIED"] = 0] = "UNCLASSIFIED";
...
class NewOrderReject extends capnp_ts_1.Struct {
    ...
    getMarketId() { return capnp_ts_1.Struct.getUint64(48, this); }
    setMarketId(value) { capnp_ts_1.Struct.setUint64(48, value, this); }
    getPrice() { return capnp_ts_1.Struct.getUint64(56, this); }
    setPrice(value) { capnp_ts_1.Struct.setUint64(56, value, this); }
    getQuantity() { return capnp_ts_1.Struct.getUint64(64, this); }
    setQuantity(value) { capnp_ts_1.Struct.setUint64(64, value, this); }
    getSide() { return capnp_ts_1.Struct.getUint16(42, this); }
    setSide(value) { capnp_ts_1.Struct.setUint16(42, value, this); }
    getTimeInForce() { return capnp_ts_1.Struct.getUint16(44, this); }
    setTimeInForce(value) { capnp_ts_1.Struct.setUint16(44, value, this); }
    getOrderType() { return capnp_ts_1.Struct.getUint16(46, this); }
    setOrderType(value) { capnp_ts_1.Struct.setUint16(46, value, this); }
    toString() { return "NewOrderReject_" + super.toString(); }
}
exports.NewOrderReject = NewOrderReject;
NewOrderReject._capnp = { displayName: "NewOrderReject", id: "f65543608c6c19f2", size: new capnp_ts_1.ObjectSize(72, 0) };
var CancelOrderRejectReason;
(function (CancelOrderRejectReason) {
    CancelOrderRejectReason[CancelOrderRejectReason["UNCLASSIFIED"] = 0] = "UNCLASSIFIED";
...
(function (ModifyOrderRejectReason) {
    ModifyOrderRejectReason[ModifyOrderRejectReason["UNCLASSIFIED"] = 0] = "UNCLASSIFIED";
...
(function (OrderResponse_Which) {
    ...
    OrderResponse_Which[OrderResponse_Which["POSITION"] = 8] = "POSITION";
...
class OrderResponse extends capnp_ts_1.Struct {
    ...
    getPosition() {
        capnp_ts_1.Struct.testWhich("position", capnp_ts_1.Struct.getUint16(0, this), 8, this);
        return capnp_ts_1.Struct.getStruct(0, AssetPosition, this);
    }
    hasPosition() { return !capnp_ts_1.Struct.isNull(capnp_ts_1.Struct.getPointer(0, this)); }
    initPosition() {
        capnp_ts_1.Struct.setUint16(0, 8, this);
        return capnp_ts_1.Struct.initStructAt(0, AssetPosition, this);
    }
    isPosition() { return capnp_ts_1.Struct.getUint16(0, this) === 8; }
    setPosition(value) {
        capnp_ts_1.Struct.setUint16(0, 8, this);
        capnp_ts_1.Struct.copyFrom(value, capnp_ts_1.Struct.getPointer(0, this));
    }
...
OrderResponse.POSITION = OrderResponse_Which.POSITION;
...
class AssetPosition extends capnp_ts_1.Struct {
    getSubaccountId() { return capnp_ts_1.Struct.getUint64(0, this); }
    setSubaccountId(value) { capnp_ts_1.Struct.setUint64(0, value, this); }
    getAssetId() { return capnp_ts_1.Struct.getUint64(8, this); }
    setAssetId(value) { capnp_ts_1.Struct.setUint64(8, value, this); }
    adoptTotal(value) { capnp_ts_1.Struct.adopt(value, capnp_ts_1.Struct.getPointer(0, this)); }
    disownTotal() { return capnp_ts_1.Struct.disown(this.getTotal()); }
    getTotal() { return capnp_ts_1.Struct.getStruct(0, RawUnits, this); }
    hasTotal() { return !capnp_ts_1.Struct.isNull(capnp_ts_1.Struct.getPointer(0, this)); }
    initTotal() { return capnp_ts_1.Struct.initStructAt(0, RawUnits, this); }
    setTotal(value) { capnp_ts_1.Struct.copyFrom(value, capnp_ts_1.Struct.getPointer(0, this)); }
    adoptAvailable(value) { capnp_ts_1.Struct.adopt(value, capnp_ts_1.Struct.getPointer(1, this)); }
    disownAvailable() { return capnp_ts_1.Struct.disown(this.getAvailable()); }
    getAvailable() { return capnp_ts_1.Struct.getStruct(1, RawUnits, this); }
    hasAvailable() { return !capnp_ts_1.Struct.isNull(capnp_ts_1.Struct.getPointer(1, this)); }
    initAvailable() { return capnp_ts_1.Struct.initStructAt(1, RawUnits, this); }
    setAvailable(value) { capnp_ts_1.Struct.copyFrom(value, capnp_ts_1.Struct.getPointer(1, this)); }
    toString() { return "AssetPosition_" + super.toString(); }
}
exports.AssetPosition = AssetPosition;
AssetPosition._capnp = { displayName: "AssetPosition", id: "80265ca54930c1f2", size: new capnp_ts_1.ObjectSize(16, 2) };
class Done extends capnp_ts_1.Struct {
    getLatestTransactTime() { return capnp_ts_1.Struct.getUint64(0, this); }
    setLatestTransactTime(value) { capnp_ts_1.Struct.setUint64(0, value, this); }
...
(function (Bootstrap_Which) {
    ...
    Bootstrap_Which[Bootstrap_Which["POSITION"] = 2] = "POSITION";
...
class Bootstrap extends capnp_ts_1.Struct {
    ...
    disownPosition() { return capnp_ts_1.Struct.disown(this.getPosition()); }
    getPosition() {
        capnp_ts_1.Struct.testWhich("position", capnp_ts_1.Struct.getUint16(0, this), 2, this);
        return capnp_ts_1.Struct.getStruct(0, AssetPosition, this);
    }
    hasPosition() { return !capnp_ts_1.Struct.isNull(capnp_ts_1.Struct.getPointer(0, this)); }
    initPosition() {
    ...
    isPosition() { return capnp_ts_1.Struct.getUint16(0, this) === 2; }
    setPosition(value) {
        capnp_ts_1.Struct.setUint16(0, 2, this);
        capnp_ts_1.Struct.copyFrom(value, capnp_ts_1.Struct.getPointer(0, this));
    }
...
Bootstrap.POSITION = Bootstrap_Which.POSITION;
